classdef CST_MicrowaveStudio < handle
    ...
    methods
        ...
        function saveas(obj,ff22,ff11)
            
            obj.mws.invoke('saveas',fullfile(ff22,[ff11,'.cst']),'false');
        end
        function save(obj)
        ...
        function translateVoxel (obj,name,x,y,z,copy,varargin)
            ...
            VBA = sprintf(['With Transform\n',...
                ...
                '.Repetitions "%d"\n',...
                '.MultipleSelection "False"\n',...
                '.Transform "Voxeldata", "Translate"\n',...
                'End With'],...
                name,x,y,z,copy,p.Results.repetitions);
        ...
        function setSolver(obj,solver)
            switch lower(solver)
                case {'frequency','f','freq'}
                    VBA = 'ChangeSolverType "LF Frequency Domain"';
                    obj.solver = 'f';
        ...
        function setsolver1(obj)
        	VBA = sprintf(['Mesh.SetCreator "Low Frequency" \n\n',...
        		'With LFSolver\n',...
			    '.Reset\n',...
			...
			obj.update('defie lf frequency domain solver parameters',VBA);
		end



		function mesh1(obj)
			VBA=sprintf(['With Mesh \n',...
				'.MeshType "PBA"\n',...
			...
			obj.update("set mesh properties (Hexahedral)",VBA);
			obj.addToHistory('set mesh properties (Hexahedral)',VBA)
        ...
        function runSimulation(obj)
            switch obj.solver
                case 'f'
                    s = obj.mws.invoke('LFSolver'); % handle to frequency domain solver
                case 't'
